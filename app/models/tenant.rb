class Tenant < ActiveRecord::Base
  ...
  validates_presence_of :name #
    ...
    def self.create_new_tenant(tenant_params, user_params, coupon_params)
      ...
      # changed so that configured params in the white list (milia.rb) all make it through
      # during the create actions when we are creating a tenant & not restricted in simply name
